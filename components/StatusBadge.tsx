...
export const StatusBadge: React.FC<StatusBadgeProps> = ({ status }) => {
  ...
  const getFriendlyLabel = (s: PlanStatus) => {
    const mapping: Record<string, string> = {
      ...
      'PRELIMINARY_SUBMITTED': 'Preliminary Review',
      'PROFORMA_ISSUED': 'Proforma Issued',
      'PAYMENT_PENDING': 'Payment Pending',
      'PAID': 'Paid',
      'DOCUMENTS_PENDING_VERIFICATION': 'Document Verification',
      'VERIFIED_BY_RECEPTION': 'Reception Verified',
      'FINAL_SUBMITTED': 'Ready for Technical Review',
      'REVIEW_POOL': 'Technical Review',
      'IN_REVIEW': 'Technical Review',
      'UNDER_REVIEW': 'Technical Review',
      'CORRECTIONS_REQUIRED': 'Needs Attention',
      'AWAITING_FINAL_DECISION': 'Final Approval',
      'REJECTED': 'Rejected',
      'APPROVED': 'Approved',
